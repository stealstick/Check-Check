...
class Problem(models.Model):
    ...
    answer = models.PositiveIntegerField(default=0, help_text="정답")
    solver = models.ManyToManyField(User, related_name="solver")
    no_solver = models.ManyToManyField(User, related_name="nosolver")
    def __str__(self):
        return self.title
